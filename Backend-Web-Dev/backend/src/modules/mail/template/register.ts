...
export const RegisterTemplate = (data: RegisterTemplateData) => {
...
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            <p>Chúng tôi nhận được yêu cầu đăng ký cho tài khoản của bạn tại <strong>${data.name_service}</strong>. Để tiến hành tạo tài khoản, vui lòng nhấp vào nút dưới đây:</p>
            <div class="button-container">
                <a href="${data.url_register}" class="button">Tạo tài khoản</a>
            </div>
  ...
  return {
    ...
    subject: `Yêu cầu đăng ký cho ${data.name_service}`, //tiêu đề
