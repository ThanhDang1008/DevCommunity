...
export const TableOfContents: React.FC<TableOfContentsProps> = ({
  ...
  return (
    <>
      <div
        className={clsx(
          "bg-white dark:bg-zinc-800 border border-gray-200 dark:border-gray-700 rounded-lg shadow-sm",
                    ...
                    <li key={`${item.id}-${index}`}>
                      <button
                        ...
                        className={clsx(
                          ...
                          // Active state
                          isActive
                            ? "bg-blue-50 dark:bg-zinc-700 text-blue-700 dark:text-blue-300 border-l-2 border-blue-500"
                            : "text-gray-700 dark:text-gray-300 hover:bg-zinc-100 dark:hover:bg-zinc-600 hover:text-gray-900 dark:hover:text-white",
                          // Focus state
                        ...
                        <span
                          className={clsx(
                            ...
                            // Font size based on heading level
                            {
                              ...
                              "text-sm": item.tag === "h3" || item.tag === "h4",
                              "text-xs": item.tag === "h5" || item.tag === "h6",
                            }
                          )}
                        >
                          {item.title}
