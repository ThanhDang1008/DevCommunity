...
type PaginationPostProps = {
  totalPosts: number;
  limitPostChildCategory: number;
  pagePostChildCategory: number;
  slug: string;
  childSlug: string;
  currentPage: number;
};

const PaginationChildCategory = (props: PaginationPostProps) => {
  const totalPages = Math.ceil(props.totalPosts / props.limitPostChildCategory);
    ...
    <>
      {isClient && (
        <Pagination
            ...
            if (type === "prev") {
              ...
              return (
                <a
                  ...
                  href={`/chu-de/${props.slug}/${props.childSlug}?p=${
                    props.currentPage - 1
                  }`}
                >
                  {"<"}
            ...
            if (type === "page") {
              return (
                <a
                  ...
                  href={`/chu-de/${props.slug}/${props.childSlug}?p=${page}`}
                  style={{
                    color: "rgb(109 0 204)",
                  }}
                >
            ...
            if (type === "jump-next" || type === "jump-prev") {
              ...
              return (
                <a
                  ...
                  href={`/chu-de/${props.slug}/${props.childSlug}?p=${pageTarget}`}
                >
          ...
          defaultPageSize={Number(props.limitPostChildCategory)}
          defaultCurrent={Number(props.pagePostChildCategory)}
...
export default PaginationChildCategory;
