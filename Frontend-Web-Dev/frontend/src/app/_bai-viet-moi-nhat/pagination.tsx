...
const PaginationPost = (props: PaginationPostProps) => {
  const totalPages = Math.ceil(props.totalPosts / props.limitPostRecent);
    ...
    <>
      {isClient && (
          ...
          <Pagination
              ...
              if (type === "prev") {
                ...
                return (
                  <a
                    ...
                    href={`/bai-viet-moi-nhat?p=${props.currentPage - 1}`}
                  >
                    {"<"}
                  </a>
                );
              ...
              if (type === "jump-next" || type === "jump-prev") {
                ...
                return (
                  <a
                    ...
                    href={`/bai-viet-moi-nhat?p=${pageTarget}`}
                  >
            ...
            defaultPageSize={Number(props.limitPostRecent)}
            defaultCurrent={Number(props.pagePostRecent)}
