...
import type { Question, QuizData } from "../toeic/MainToeic";
...
import { PlayVideoYoutube } from "../toeic/PlayVideoYoutube";
...
const PartQuiz = (props: ToeicPart3QuizProps) => {
    ...
    const fetchQuizData = async () => {
      ...
      try {
        ...
        const response = await NextAPI<QuizData>(
          `${DOMAIN_FILE}/file/storage/chu-nghia-xa-hoi-khoa-hoc.json`,
          {
            method: "GET",
          },
          {
        ...
        if (response.status === 200) {
          ...
          if (!response?.data["test"]) {
            console.warn(`No data found for test`);
            return;
          }
          const testData = response?.data["test"] || [];
          if (testData.length === 0) {
            console.warn(`No questions found for test`);
            return;
          }
          //setDataPart({});
    ...
    <>
      ...
      >
        ...
        <div className="mb-8">
          ...
          <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-4 mt-6 gap-4">
            <div>
